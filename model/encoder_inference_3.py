...
class AutoEncoder(object):
    ...
    def encoderWeight(self):
        with tf.variable_scope('Encoder_weight3',reuse=tf.AUTO_REUSE):
    ...
    def encoderBias(self):
        with tf.variable_scope('Encoder_bias3',reuse=tf.AUTO_REUSE):
    ...
    def decoderWeight(self,Inputs):
        with tf.variable_scope('Decoder_weight3',reuse=tf.AUTO_REUSE):
    ...
    def decoderBias(self):
        with tf.variable_scope('Decoder_bias3',reuse=tf.AUTO_REUSE):
